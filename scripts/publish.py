...
def main() -> int:
    print("🚀 Starting wikisets publish process...")
    ...
    run(["gh", "release", "create", tag, "--title", f"wikisets v{version}", "--notes-file", notes_path])

    print("🎉 wikisets publish process completed successfully!")
